        ...
        <> 
            ...
            <Drawer anchor='left' open = {isDrawerOpen} onClose ={() => setIsDrawerOpen(false)} >
                <Box p={2} width='250px' textAlign='center' role='presentation'>
                    ...
                    <Button href="/CreateEvent" variant="contained" style={{backgroundColor: "#B3A369"}}>
                        Create Event
                    </Button> <br /> <br />

                    <Button href="/EditEvent" variant="contained" style={{backgroundColor: "#B3A369"}}>
                        Edit Event
                    </Button> <br /> <br />

                    <Button href="/DeleteEvent" variant="contained" style={{backgroundColor: "#B3A369"}}>
                        DeleteEvent
                    </Button> <br/> <br />
